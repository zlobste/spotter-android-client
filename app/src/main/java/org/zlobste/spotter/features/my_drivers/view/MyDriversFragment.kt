...
class MyDriversFragment : ScopedFragment(), KodeinAware {
    ...
    private fun initToolbar() {
        requireActivity().toolbar_with_image.title_text_view.text = getString(R.string.my_drivers)
    }
    ...
    private fun initRecyclerView() {
        ...
        driversAdapter.replace(MyDrivers.driversList.values.toList())
    ...
    companion object {
        fun getInstance() = MyDriversFragment()
    }
}